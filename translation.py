...
URL | filename | username | password"""
    NOYES_URL = "I can upload to Telegram, without me slowing down for other users."
    DOWNLOAD_START = "• Downloading..."
    UPLOAD_START = "• Uploading..."
    RCHD_BOT_API_LIMIT = "size greater than maximum allowed size (50MB). Neverthless, trying to upload."
    RCHD_TG_API_LIMIT = "Downloaded in {} seconds.\nDetected File Size: {}\nSorry. But, I cannot upload files greater than 1.5GB due to Telegram API limitations."
    AFTER_SUCCESSFUL_UPLOAD_MSG = "Please rate me if you find me useful. Join : @GETUPlOAD"
    ...
    CURENT_PLAN_DETAILS = """• id: <code>{}</code>"""
...
• Channel: @GETUPLOAD"""
    ...
    EXTRACT_ZIP_ERRS_OCCURED = "Sorry. Errors occurred while processing compressed file. Please check everything again twice, and if the issue persists, report this to <a href='https://telegram.me/GETUPlOAD'>@GETUPlOAD</a>"
